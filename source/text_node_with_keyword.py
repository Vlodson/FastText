...
from text_preprocesssing import preprocess_corpus, load_corpus, clean_text, make_word_list, remove_stopwords
...
def main():
    ...
    keyword_similarities = keywords_similarity(["lorem", "pera", "consectetum"], node_words, ngram_vectors, vector_space)
